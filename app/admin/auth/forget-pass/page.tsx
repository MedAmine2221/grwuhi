        ...
        <div className="rounded-2xl overflow-hidden bg-white shadow-xl border border-gray-100">
          <div className="px-8 pt-9 pb-10">
            ...
            <div className="flex items-center gap-3 mb-7">
              ...
              <span className="text-xs text-gray-400 tracking-widest uppercase">Recovery</span>
              <div className="flex-1 h-px bg-gray-200" />
            </div>
            ...
            {sent ? (
              ...
              >
                <motion.div
                  ...
                  className="mx-auto mb-4 w-14 h-14 rounded-full flex items-center justify-center bg-green-100"
                >
                ...
                <p className="text-sm text-gray-500 mb-6">
                  Check your inbox at <span className="text-blue-600">{email}</span>
                </p>
                <motion.button
              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <motion.button
                    ...
                    className="relative w-full py-3 rounded-xl text-sm font-semibold overflow-hidden transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed bg-blue-600 text-white hover:bg-blue-700"
                  >
